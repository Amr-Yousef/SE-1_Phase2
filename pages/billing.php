                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <form method="post">
                                                                <button class="text-secondary font-weight-bold text-xs" style="border: none;background: none;text-decoration: underline;text-underline-offset: 0.3rem;text-decoration-thickness: 0.1rem;" data-toggle="tooltip" data-original-title="Edit user" type="submit" name="<?= $transaction->getID() ?>">
                                                                    إبلاغ
                                                                </button>
                                                            </form>
                                                        </td>
