                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            ...
                            <p class="text-lead text-white">قم بتسجيل الدخول إلى حسابك من أجل أن تبدأ بإستعمال خدماتنا
                                ومنتجاتنا.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                <form role="form text-left" method="POST">
                                    <div class="mb-3">
                                        <input type="email" name="user" class="form-control" placeholder="الإيميل الإلكتروني" aria-label="Email" aria-describedby="email-addon">
                                    </div>
                                    <div class="mb-3">
                                        <input type="password" name="pass" class="form-control" placeholder="كلمة السر" aria-label="Password" aria-describedby="password-addon">
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">تسجيل الدخول</button>
                                    </div>
                                    <p class="text-sm mt-3 mb-0">نسيت كلمة مرورك؟ <a href="javascript:;" class="text-dark font-weight-bolder">إسترجاع كلمة المرور.</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
